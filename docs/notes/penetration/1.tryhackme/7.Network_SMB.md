...
![](assets/7.network_smb/file-20241022212054.png)
:::
## 枚举SMB
...
::: details  好的，我会的现在我们知道了这一点，我们应该在共享上的哪个目录中查找？
**答案**：`.ssh`

:::

:: details  此目录包含允许用户在服务器上进行身份验证并随后访问服务器的身份验证密钥。这些钥匙中哪一个对我们最有用？
...
::: details  What is the smb.txt flag?
