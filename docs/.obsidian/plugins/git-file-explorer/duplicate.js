...
// src/widgets/utils/debouncer.ts
var Debouncer = class {
  ...
  async debounceAndRunWhenIdle(fun) {
    if (this.timerId)
...
var WidgetManager = class {
  constructor(factory, fileExplorerHandler, basePath) {
    ...
    this.uninstallAll = () => this.widgets.forEach((widget) => widget.uninstall());
...
var NavColorUpdater = class {
  constructor(navFolderTitleEl) {
    this.isNavItemInAnotherRepo = (navItemEl) => {
      var _a2, _b;
      return !((_b = navItemEl == null ? void 0 : navItemEl.closest(".git-widget-container")) == null ? void 0 : _b.isEqualNode((_a2 = this.navFolderEl) != null ? _a2 : HTMLElement.prototype));
    };
    this.hasItemChanged = (nodes, navPath) => nodes.some((node) => {
      var _a2;
      const vaultNodeRelPath = path.join(
        (_a2 = this.repoRelPath) != null ? _a2 : "",
        node.path
      );
  ...
  update(gitNodes) {
    if (!this.navFolderEl || !this.repoRelPath)
      return;
    const navItems = this.navFolderEl.querySelectorAll("div[data-path]");
    navItems == null ? void 0 : navItems.forEach((navItem) => {
      if (this.isNavItemInAnotherRepo(navItem))
        return;
      ...
      if (itemPath && this.hasItemChanged(gitNodes, itemPath))
        ...
        navItem.removeClass("git-changed-file");
    });
  }
};
...
var ChangesGitWidget = class extends GitWidget {
  constructor(navFolderTitleEl, gitRepository, app, promptCommitMsg = false, enableNavColorUpdater = true) {
...
var SyncGitWidget = class extends GitWidget {
  constructor(parent, gitRepository) {
...
var GitFileExplorerSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Enable prompting commit message").setDesc(
    ...
    new import_obsidian3.Setting(containerEl).setName("Change color of changed files in the file explorer").addToggle(
