...
# 网络入门
##  OSI
![](../images/Pasted%20image%2020240713204132.png)

##  TCP/IP

![](../images/Pasted%20image%2020240713203822.png)



## ping

![](../images/Pasted%20image%2020240713204454.png)


##  traceroute

![](../images/Pasted%20image%2020240713204651.png)
...
## 交互
当我们对一个系统进行渗透时，知道的信息越多，就会越容易，因此需要在进行任何漏洞利用尝试之前进行必要的枚举。
...
### TCP 协议包头
---
![](../images/Pasted%20image%2020240714165310.png)
...
使用Nmap进行端口扫描时，有三种基本扫描类型。这些措施包括：
...
#### SYN“半开”扫描（`-sS`）
````ad-info
title:"Half-Open" or "Stealth"

用于绕过旧的入侵检测系统，对现在的IDS解决方案不再适用
...
![](../images/Pasted%20image%2020240714172054.png)

````
![](../images/Pasted%20image%2020240714173123.png)
...
![](../images/Pasted%20image%2020240714174646.png)
...
![](../images/Pasted%20image%2020240714182241.png)
...
```
![](../images/Pasted%20image%2020240714183022.png)
...
![](../images/Pasted%20image%2020240714183707.png)
````
...
![](../images/Pasted%20image%2020240714201322.png)
...
![](../images/Pasted%20image%2020240714201811.png)
...
>Tips：ARP 扫描仅适用于局域网环境，因为它依赖于 ARP 协议，该协议用于在局域网内解析 IP 地>到 MAC 地址。
>
...
## 问题回答
![](../images/Pasted%20image%2020240714205759.png)

````ad-info
title:使用nmap NSE 脚本登陆FTP
